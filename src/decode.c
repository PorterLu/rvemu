 ...
 *  normal types
*/
#define OPCODE(data) (((data) >>  2) & 0x1f)    //opcode
#define RD(data)     (((data) >>  7) & 0x1f)    //source operand1
#define RS1(data)    (((data) >> 15) & 0x1f)    //source operand2
#define RS2(data)    (((data) >> 20) & 0x1f)    //source operand3
#define RS3(data)    (((data) >> 27) & 0x1f)    
#define FUNCT2(data) (((data) >> 25) & 0x3 )
#define FUNCT3(data) (((data) >> 12) & 0x7 )
#define FUNCT7(data) (((data) >> 25) & 0x7f)
#define IMM116(data) (((data) >> 26) & 0x3f)    //immediate number
